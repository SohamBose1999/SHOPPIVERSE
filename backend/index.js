...
mongoose.connect("mongodb+srv://sohambose2024:soham2024@cluster0.ddebudy.mongodb.net/e-commerce", {
...
app.post("/upload", upload.single("product"), (req, res) => {
    res.json({
        success: 1,
        image_url: `https://shoppiverse-backend-v1.onrender.com/images/${req.file.filename}`
    });
});
